...
#     @mcp.tool()
#     def list_executable_generated_outputs() -> list[dict]:
#         return executor.list_executable_generated_outputs()
    
#     @mcp.tool()
#     def execute_generated_output(name: str, mode: str = "dry_run") -> dict:
#         return executor.execute_generated_output(name, mode)

#     @mcp.tool()
#     def execute_testcase_by_id(name: str, testcase_id: str, mode: str = "dry_run") -> dict:
#         return executor.execute_testcase_by_id(name, testcase_id, mode)

#     @mcp.tool()
#     def read_execution_report(run_id: str) -> dict:
#         return executor.read_execution_report(run_id)
...
#     @mcp.resource("executions://reports")
#     def execution_reports() -> str:
#         items = [str(p) for p in executor.executions_dir.glob("*/report.json")]
#         return "\n".join(sorted(items))

#     @mcp.resource("executions://report/{run_id}")
#     def execution_report(run_id: str) -> str:
#         import json
...
if FastMCP is None:
    ...
    @mcp.resource("generated://executables")
    def generated_executables() -> str:
        import json
    ...
    @mcp.resource("executions://reports")
    def execution_reports() -> str:
        items = executor.list_execution_reports()
        return "\n".join(items)
