...
def export_test_cases_excel(output: Any, file_path: str | Path) -> Path:
    ...
    headers = ["TC ID", "Title", "Type", "Preconditions", "Steps", "Expected Result"]
    ws.append(headers)
    ...
    for feat in features_list:
        ...
        for tc in test_cases:
            ...
            row_data = [tc_id, title, tc_type, preconditions_str, steps_str, expected_str]
            ws.append(row_data)
