...
for feature in features_to_generate:
    ...
    if no_new:
        ...
        print(f"  Feature fully covered by model. Total: {total_count} test cases.")
    elif new_count == 0:
        print(f"  Model generated 0 new test cases (all duplicates). Total: {total_count} test cases.")
    else:
        total_new_tc_count += new_count
        print(f"  {new_count} new test cases added. Total: {total_count} test cases.")
